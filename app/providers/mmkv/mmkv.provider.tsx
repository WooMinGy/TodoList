...
export enum EnumMMKVKeystoreString {
  'IS_DONE_ARRAY' = 'IS_DONE_ARRAY',
}

export type IMMKVKeystoreString = EnumMMKVKeystoreString;

export enum EnumMMKVKeystoreNumber {
  'EXAMPLE' = 'EXAMPLE',
}

export type IMMKVKeystoreNumber = EnumMMKVKeystoreNumber;

export enum EnumMMKVKeystoreBoolean {
  'EXAMPLE' = 'EXAMPLE',
}

export type IMMKVKeystoreBoolean = EnumMMKVKeystoreBoolean;

export const MMKVProvider = ({ children }: IMMKVProviderProps) => {
  const [keystore, setKeystore] =
    useState<TypedMMKVInterface<IMMKVKeystoreString, IMMKVKeystoreNumber, IMMKVKeystoreBoolean>>(
      createKeyStore<IMMKVKeystoreString, IMMKVKeystoreNumber, IMMKVKeystoreBoolean>(),
    );
  useEffect(() => {
    const listener = keystore.addOnValueChangedListener(() => {
